Crossroad Detector Algorithm Sample
===================================

General Description
-------------------

This directory contains a sample for the Crossroad Detector algorithm. One
sample is available:

* main - detects objects on an image and prints information about them.

For more information about the sample, refer to the readme.txt file in the "main" directory.
...
3. Configure the build with CMake:
   ...
   cmake -D CMAKE_PREFIX_PATH="<CVA_DIR>" \
	   "<CVA_DIR>/share/cva/CrossroadDetector/doc/examples/<EXAMPLE_NAME>"

4. Build the sample:

   cmake --build .

The build system will place the built application as cva_crd_example_<EXAMPLE_NAME> 
...
3. Configure the build with CMake:
   ...
   cmake -G "Visual Studio 14 2015 Win64" -D CMAKE_PREFIX_PATH="<CVA_DIR>" ^
	   "<CVA_DIR>\share\cva\CrossroadDetector\doc\examples\<SAMPLE_NAME>"
...
Release\cva_crd_example_<EXAMPLE_NAME>.exe in the specified build directory.
