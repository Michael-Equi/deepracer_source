Person Attributes Classification Algorithm Sample
=================================================

General Description
-------------------

This directory contains a sample for the Person Attributes Classification algorithm. One
sample is available:

* classify - classifies a person on an image and prints their attributes.

For more information about the sample, refer to the readme.txt file in the "classify" directory.
...
* <SAMPLE_NAME> - a name of the example (the same as the name of its directory)
* <WORK_DIR> - a directory where you want to build the sample
...
3. Configure the build with CMake:
   ...
   cmake -D CMAKE_PREFIX_PATH="<CVA_DIR>" \
	   "<CVA_DIR>/share/cva/PersonAttributesClassification/doc/examples/<EXAMPLE_NAME>"

4. Build the sample:

   cmake --build .

The build system will place the built application as cva_pac_example_<EXAMPLE_NAME> 
...
3. Configure the build with CMake:
   ...
   cmake -G "Visual Studio 14 2015 Win64" -D CMAKE_PREFIX_PATH="<CVA_DIR>" ^
	   "<CVA_DIR>\share\cva\PersonAttributesClassification\doc\examples\<SAMPLE_NAME>"
...
Release\cva_pac_example_<EXAMPLE_NAME>.exe in the specified build directory.
