Vehicle Attributes Classification Algorithm Sample
==================================================

General Description
-------------------

This directory contains a sample for the Vehicle Attributes Classification algorithm. The sample is:

* classify - for an image of a vehicle, prints the probabilities of it being of
    each supported type and color.

For more information about the sample itself, see the readme.txt file in the
"classify" directory.
...
* <WORK_DIR> - the directory where you want to build the sample
...
3. Configure the build with CMake:
   ...
   cmake -D CMAKE_PREFIX_PATH="<CVA_DIR>" \
      "<CVA_DIR>/share/cva/VehicleAttributesClassification/doc/examples/<EXAMPLE_NAME>"

4. Build the sample:

   cmake --build .

The build system will place the built application as cva_vc_example_<SAMPLE_NAME> in the specified build directory.
...
3. Configure the build with CMake:
   ...
   cmake -G "Visual Studio 14 2015 Win64" -D CMAKE_PREFIX_PATH="<CVA_DIR>" ^
        "<CVA_DIR>\share\cva\VehicleAttributesClassification\doc\examples\<SAMPLE_NAME>"
...
Release\cva_vc_example_<EXAMPLE_NAME>.exe in the specified build directory.

Running the Samples
-------------------

For information on how to run the sample, refer to the readme.txt files in the sample folder.
