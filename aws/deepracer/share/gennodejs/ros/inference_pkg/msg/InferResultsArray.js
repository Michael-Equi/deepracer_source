...
let InferResults = require('./InferResults.js');
let sensor_msgs = _finder('sensor_msgs');

//-----------------------------------------------------------

class InferResultsArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.results.forEach((val) => {
      bufferOffset = InferResults.serialize(val, buffer, bufferOffset);
    });
  ...
  static datatype() {
    ...
    return 'inference_pkg/InferResultsArray';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '5ad60674567d635f03223247f4d48371';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: inference_pkg/InferResults
    int32 classLabel
    float32 classProb
    float32 xMin
    float32 yMin
...
module.exports = InferResultsArray;
